            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type="text" class="form-control primNamez" placeholder="分類名稱（建議字數在 5 個字元內）">
                    </div>
                </div>
            </div>
...
CONNECT = 'taiwanDojo/category';
// 接收資料，做渲染、處理
function process(data) {
    html = "";
    for (let i = 0; i < data.length; i++) {
        html += `
            <div data-numz="${data[i].categoryId}" class="card">
                <div class="card-header">
                    <div class="row">
                ...
                <div class="card-body">
                    <div class="row sorts">
                        <div class="sort form-group d-flex align-items-center col-md-8">
                        ...
                        <div class="sort form-group d-flex justify-content-end col-md-4">
...
// 驗證
function dataAddCheck(aId, title) {
    if (aId.trim() === '') {
        return check = false, errorText = '請確認必填欄位皆有填寫！';
    }
    if (title.val().trim() === '' || title.val().length > 20) {
        title.focus();
        return check = false, errorText = '請確認分類名稱是否確實填寫、格式是否正確（長度不得超過 20 字元）！';
    }
    else {
