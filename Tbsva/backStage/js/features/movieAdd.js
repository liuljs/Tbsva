// 宣告要帶入的欄位
let topz = $('.topz'), titlez = $('.titlez'), imgFilez = $('.imgFilez'), titleImagez = $('.titleImagez'), linkz = $('.linkz'), URLz, uIdz, coverz, titleSamplez = $('.titleSamplez'), covers, contentz = $('.contentz');
