...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR2Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR2Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r2";
        private string directoryName = "textEditorR2";
