...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR6Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR6Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r6";
        private string directoryName = "textEditorR6";
