...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR10Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR10Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r10";
        private string directoryName = "textEditorR10";
