...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR1Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR1Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r1";
        private string directoryName = "textEditorR1";
