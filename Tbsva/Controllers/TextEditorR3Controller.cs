...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR3Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR3Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r3";
        private string directoryName = "textEditorR3";
