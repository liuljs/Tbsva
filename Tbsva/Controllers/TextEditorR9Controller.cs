...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR9Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR9Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r9";
        private string directoryName = "textEditorR9";
