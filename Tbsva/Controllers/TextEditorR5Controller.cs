...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR5Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR5Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r5";
        private string directoryName = "textEditorR5";
