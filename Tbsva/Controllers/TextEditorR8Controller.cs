...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR8Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR8Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r8";
        private string directoryName = "textEditorR8";
