...
namespace WebShopping.Controllers
{
    ...
    public class TextEditorR7Controller : ApiController
    {
        #region DI依賴注入功能
        ...
        public TextEditorR7Controller(ITextEditorService textEditorService, IMapper mapper, IImageFormatHelper imageFormatHelper)
        {
        ...
        private string tableName = "text_editor_r7";
        private string directoryName = "textEditorR7";
